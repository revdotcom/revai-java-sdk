...
/**
 * <p>Providing a custom vocabulary is optional. Use object assigns a custom vocabulary to be
...
public class SessionConfig {
    ...
    public SessionConfig(Boolean filterProfanity, String customVocabularyId) {
        this.filterProfanity = filterProfanity;
        this.customVocabularyId = customVocabularyId;
    }

    public SessionConfig(Boolean filterProfanity) {
        this.filterProfanity = filterProfanity;
    }

    public SessionConfig(String customVocabularyId) {
        this.customVocabularyId = customVocabularyId;
    }
